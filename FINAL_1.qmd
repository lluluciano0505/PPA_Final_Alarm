...
We recode incident types following NFIRS conventions. All 7xx events represent False Alarm & False Call responses (e.g., system malfunctions, detector errors, malicious alarms) and therefore form the positive class (1). In contrast, 1xx and 2xx codes correspond to real fire and overpressure/explosion incidents. These categories reflect genuine events requiring response and are thus coded as 0. This recoding cleanly separates false alarms from all non–false alarm incidents for modeling purposes.
...
### 2.4 Join the alarm data to census tracts
...
### 2.6 Identify the Work Days and Weekends
...
### 3.1 Join daily weather to fire incidents
...
### 3.2 Join the Fire Station Buffer
...
### 3.3 Combine with Census Tract Data
...
### 4.1 Map: False Alarm Rate by Census Tract
...
### 4.2 Bar Chart: False Alarm Rate by Quarter
...
### 5.1 Logit Model1: with wealther data
...
### 5.2 Model 2: socio-economic added
